...
vim.g.mapleader = "Space"  -- anywhere you see <leader> = hit space
...
vim.o.background = "dark" -- set to "light" for dark theme
...
-- Plugin config
-- -----------------------------------------------------------------------------------------------
vim.cmd.colorscheme("solarized")  -- activate the theme
...
-- -----------------------------------------------------------------------------------------------
-- Basic keys
vim.keymap.set("n", "<,>", ":")  -- hit <,> to start a command, quicker than :
